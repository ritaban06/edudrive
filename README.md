# EduDrive - Study Material Platform
...
```bash
git clone https://github.com/ritaban06/edudrive.git
cd edudrive
```
...
PORT=5000
MONGODB_URI=mongodb://localhost:27017/edudrive
...
npm install -g pm2
pm2 start server.js --name "edudrive-backend"
pm2 startup
pm2 save
```
