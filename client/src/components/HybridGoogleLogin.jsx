        ...
        <div className="flex justify-center">
          {isLoading ? (
            ...
            <div className="w-full space-y-3">
              {/* Redirect-based OAuth (Recommended for Capacitor) */}
              <button
                onClick={handleRedirectOAuth}
                className="w-full bg-white hover:bg-gray-50 text-gray-700 font-semibold py-3 px-4 rounded-lg border border-gray-300 shadow-sm transition-all duration-200 flex items-center justify-center space-x-3"
              >
              ...
              {/* Fallback popup-based OAuth (Web only) */}
