        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <div className="flex-shrink-0 flex items-center">
              <img src="/newlogo.webp" alt="EduDrive" className="h-8 w-auto" />
            </div>
	  ...
	  <div className="flex justify-between items-center h-16 md:h-20">
			...
			<div className="w-full max-w-7xl mx-auto px-4 pt-8 xs:pt-36 lg:pt-24 pb-6 sm:pb-8 md:pb-10 text-center relative">
				...
				<div className="mt-3 xs:mt-4 sm:mt-5 text-sm xs:text-base sm:text-lg md:text-xl text-white/70 max-w-xl sm:max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto animate-fade-in-up">
					...
					<p className="mt-3">
						With EduDrive Premium, we bring everything you need right at your fingertips.
					</p>
				</div>
			...
			<div ref={featuresRef} className="w-full mx-auto px-4 xs:px-6 sm:px-8 md:px-10 py-12 sm:py-16 md:py-20" style={{ zIndex: 10, position: 'relative' }}>
				<div className="text-center mb-12 sm:mb-16 md:mb-20">
					...
					<h2 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold text-white inline-block relative">
						Why Students Choose <span className="text-[#6c47ff]">EduDrive</span>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
					...
					<div className="bg-gradient-to-br from-[#6c47ff]/10 via-[#6c47ff]/15 to-[#6c47ff]/10 backdrop-blur-md rounded-2xl border border-[#6c47ff]/20 p-6 sm:p-8 relative">
						...
						<p className="text-white/80 italic mb-6 text-sm sm:text-base">
							"The resources on EduDrive helped me secure a top rank in my semester exams. The well-organized notes and 24/7 mentorship made a huge difference in my preparation strategy."
						</p>
					...
					<div className="bg-gradient-to-br from-[#6c47ff]/10 via-[#6c47ff]/15 to-[#6c47ff]/10 backdrop-blur-md rounded-2xl border border-[#6c47ff]/20 p-6 sm:p-8 relative">
						...
						<p className="text-white/80 italic mb-6 text-sm sm:text-base">
							"The night before my exams, I had some urgent questions. The mentors at EduDrive responded immediately on WhatsApp and cleared all my doubts. Their support has been invaluable throughout my academic journey."
						</p>
						<div className="flex items-center">
			...
			<div ref={contactRef} id="contact" className="w-full max-w-6xl mx-auto px-4 py-16 sm:py-20 md:py-24">
				<div className="text-center mb-12">
					...
					<p className="mt-5 text-white/70 max-w-2xl mx-auto text-sm sm:text-base">
						Have questions about EduDrive? We're here to help! Fill out the form below and our team will get back to you as soon as possible.
					</p>
				</div>
							...
							<div className="space-y-4">
								<div className="flex items-start">
									...
									<div className="ml-3">
										...
										<p className="text-white text-sm font-medium mt-1">edudrive.ritaban@gmail.com</p>
									</div>
								</div>
			...
			<div className="w-full py-12 sm:py-16 mt-12 border-t border-white/10 bg-black/20 backdrop-blur-sm">
				<div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
					<div className="text-center md:text-left">
						<h4 className="text-white font-semibold text-lg mb-4">About EduDrive</h4>
						<p className="text-white/50 text-sm leading-relaxed">
							EduDrive is the ultimate educational platform designed to help students excel in their academic journey through comprehensive resources and personalized mentorship.
						</p>
					</div>
					...
					<div className="text-center md:text-right">
						...
						<div className="flex justify-center md:justify-end gap-5">
							<a href="https://www.facebook.com/edudrive/" className="text-white/50 hover:text-[#6c47ff] transition-colors duration-300">
								<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
									<path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
								</svg>
							</a>
							<a href="https://www.instagram.com/edudrive/" className="text-white/50 hover:text-[#6c47ff] transition-colors duration-300">
								<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
